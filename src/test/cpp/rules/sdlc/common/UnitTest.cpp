...
#include <rules/sdlc/common/ConfigurableEventListener.hpp>
#include <rules/sdlc/common/CustomEnvironment.hpp>
...
log4cxx::LoggerPtr UnitTest::logger = log4cxx::Logger::getLogger(std::string("rules.sdlc.stdc.test.UnitTest"));

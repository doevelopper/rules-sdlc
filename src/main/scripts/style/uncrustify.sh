...
#find . -regextype posix-extended -regex '.*\.[CcHh][XxPp]{2}?' -exec uncrustify -c /home/happyman/repositories/cfs-platform/rules_sdlc/tools/style/code-style.cfg --no-backup --replace {} \;

uncrustify -c /home/happyman/repositories/cfs-platform/rules_sdlc/tools/style/code-style.cfg --no-backup --replace
...
copy_file(
    name = "log4cxx_h",
    src = "@//src/main/resources/soup/log4cxx/unix:log4cxx.h",
    out = "src/main/include/log4cxx/log4cxx.h",
)

copy_file(
    name = "log4cxx_private_h",
    src = "@//src/main/resources/soup/log4cxx/unix:log4cxx_private.h",
    out = "src/main/include/log4cxx/private/log4cxx_private.h",
)

copy_file(
    name = "boost-std-configuration.h",
    src = "@//src/main/resources/soup/log4cxx/unix:boost-std-configuration.h",
    out = "src/main/include/log4cxx/boost-std-configuration.h",
)
...
cc_library(
    ...
    srcs = [
        ...
        # "src/main/cpp/asyncappender_nonblocking.cpp", $<IF:$<BOOL:LOG4CXX_BLOCKING_ASYNC_APPENDER>,asyncappender.cpp,asyncappender_nonblocking.cpp>
        ...
        "src/main/cpp/colorendpatternconverter.cpp",
        "src/main/cpp/colorstartpatternconverter.cpp",
    ...
    # copts = [
    #     "-Iexternal/org_apache_apr/apr/include/apr-1/",
    #     "-Iexternal/org_apache_apr_util/aprutil/include/apr-1/"
    # ],

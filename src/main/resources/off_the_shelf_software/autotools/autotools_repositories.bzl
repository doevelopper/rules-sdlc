...
def autotools_repositories():
    ...
    maybe(
        http_archive,
        name = "m4",
        build_file = Label("@com.github.doevelopper.rules-sdlc//src/main/resources/off_the_shelf_software/autotools:BUILD.m4.bazel"),
    ...
    maybe(
        http_archive,
        name = "autoconf",
        build_file = Label("@com.github.doevelopper.rules-sdlc//src/main/resources/off_the_shelf_software/autotools:BUILD.autoconf.bazel"),
    ...
    maybe(
        http_archive,
        name = "automake",
        build_file = Label("@com.github.doevelopper.rules-sdlc//src/main/resources/off_the_shelf_software/autotools:BUILD.automake.bazel"),
    ...
    maybe(
        http_archive,
        name = "libtool",
        build_file = Label("@com.github.doevelopper.rules-sdlc//src/main/resources/off_the_shelf_software/autotools:BUILD.libtool.bazel"),

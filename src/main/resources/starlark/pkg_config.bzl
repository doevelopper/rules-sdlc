...
load("@com.github.doevelopper.rules-sdlc//utils:common.bzl", "path", "which")

_DEFAULT_TEMPLATE = Label("@com.github.doevelopper.rules-sdlc//utils:pkg_config.BUILD.tpl")

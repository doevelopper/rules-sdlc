"""
# Copyright 2018-2021, Adrien H.L
#
...
# @unused  UNDEFINED_BEHAVIOR_SANITIZER
...
# @unused THREAD_SANITIZER_LINKOPT
# THREAD_SANITIZER_LINKOPT = select({
#     "//conditions:default": [
#         "-fsanitize=thread",
#         "-fsanitize=thread",
...
# @unused  ADDRESS_SANITIZER_LINKOPT
# ADDRESS_SANITIZER_LINKOPT = select({
#     "//conditions:default": [
#         "-fsanitize=address",
#         "-fsanitize=float-divide-by-zero",
#         "-fsanitize=nullability",
...
DEFAULT_COPTS = WERROR + select({
    "@bazel_tools//tools/cpp:msvc": MSVC_FLAGS,
    "@bazel_tools//tools/cpp:clang-cl": CLANG_CL_FLAGS,
    "@bazel_tools//tools/cpp:gcc": GCC_FLAGS,
    "@bazel_tools//tools/cpp:clang": LLVM_FLAGS,
    "//conditions:default": GCC_FLAGS,
})

TEST_COPTS = DEFAULT_COPTS + select({
    "@bazel_tools//tools/cpp:msvc": MSVC_TEST_FLAGS,
    "@bazel_tools//tools/cpp:clang-cl": CLANG_CL_TEST_FLAGS,
    "@bazel_tools//tools/cpp:gcc": GCC_TEST_FLAGS,
    "@bazel_tools//tools/cpp:clang": LLVM_TEST_FLAGS,

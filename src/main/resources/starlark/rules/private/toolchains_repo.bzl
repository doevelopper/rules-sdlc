...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@com.github.doevelopper.rules-sdlc//src/main/resources/starlark/rules:toolchain_type"]
    return [
        toolchain_info,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@com.github.doevelopper.rules-sdlc//src/main/resources/starlark/rules:toolchain_type"],
...
toolchain(
    ...
    toolchain_type = "@com.github.doevelopper.rules-sdlc//src/main/resources/starlark/rules:toolchain_type",
)
""".format(
            platform = platform,

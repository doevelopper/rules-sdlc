...
#ifndef COM_GITHUB_DOEVELOPPER_RULES_SDLC_APP_METHOD_HPP
#define COM_GITHUB_DOEVELOPPER_RULES_SDLC_APP_METHOD_HPP

#include <com/github/doevelopper/rules/sdlc/app/MethodCaller.hpp>

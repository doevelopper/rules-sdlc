...
class CFS_API_EXPORT ApplicationPrivate
{
...
private:
    ...
    cfs::utils::app::OptionDesc m_appplicationOptions;
    cfs::utils::app::OptionDesc m_appplicationConfigOptions;
    cfs::utils::app::OptionMap  m_optionMap;

...
#include <rules/sdlc/std/log/ColorStdOuputLogMsg.hpp>
...
void
    ColorStdOuputLogMsg::setColor ( bool value )
{
    colorless = ! value;
}

void
    ColorStdOuputLogMsg::setPrintLocation ( bool value )
{
    printLocation = value;
}

void
    ColorStdOuputLogMsg::format ( log4cxx::LogString & _output, log4cxx::spi::LoggingEventPtr const & event,
        ...
        if ( printLocation )
        {
            ...
            else
            {
                output << "\n  -> " << COLOR_TYPE[ColorStdOuputLogMsg::Yellow]
                       ...
                       << ":" << COLOR_TYPE[ColorStdOuputLogMsg::Red]
                       << event->getLocationInformation ( ).getLineNumber ( ) << COLOR_TYPE[ColorStdOuputLogMsg::Reset];
            }
        }
        output << std::endl;
        _output = output.str ( );
...
void
    ColorStdOuputLogMsg::setOption ( const log4cxx::LogString & option, const log4cxx::LogString & value )
{
    ...
    /*
       ...
       if(log4cxx::helpers::StringHelper::equalsIgnoreCase(option, LOG4CXX_STR("PRINTLOCATION"),
       LOG4CXX_STR("printlocation")))
       {
...
std::ostream &
    ColorStdOuputLogMsg::reset ( std::ostream & stream )
{
...
std::ostream &
    ColorStdOuputLogMsg::bold ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::dark ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::underline ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::blink ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::reverse ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::concealed ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::grey ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::red ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::green ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::onGrey ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::onYellow ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::onRed ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::onGreen ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
 ...
 */
std::ostream &
    ColorStdOuputLogMsg::onBlue ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::onMagenta ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::onCyan ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {
...
std::ostream &
    ColorStdOuputLogMsg::onWhite ( std::ostream & stream )
{
    ColorStdOuputLogMsg::Term internalStream;
    if ( internalStream.isAttyTerminal ( stream ) )
    {

...
#include <rules/sdlc/std/logging/LoggingServicePrivate.hpp>
...
void
    LoggingServicePrivate::flush ( )
{
    LOG4CXX_TRACE ( log4cxx::Logger::getRootLogger ( ), __LOG4CXX_FUNC__ );
}

bool
    LoggingServicePrivate::loggerReset ( )
{
    LOG4CXX_TRACE ( log4cxx::Logger::getRootLogger ( ), __LOG4CXX_FUNC__ );
...
std::string
    LoggingServicePrivate::getFileExtension ( const std::string & s )
{
    LOG4CXX_TRACE ( log4cxx::Logger::getRootLogger ( ), __LOG4CXX_FUNC__ );
 ...
 */
void
    LoggingServicePrivate::loggerConfigure ( std::string const & filename )
{
    LOG4CXX_TRACE ( log4cxx::Logger::getRootLogger ( ), __LOG4CXX_FUNC__ );
...
bool
    LoggingServicePrivate::initLogger ( )
{
...
void
    LoggingServicePrivate::setLoggerLevel ( const std::string & loggerId, const std::string & level )
{
    LOG4CXX_TRACE ( log4cxx::Logger::getRootLogger ( ), __LOG4CXX_FUNC__ );
...
void
    LoggingServicePrivate::setRootDefaultLevel ( const std::string & level )
{
    LOG4CXX_TRACE ( log4cxx::Logger::getRootLogger ( ), __LOG4CXX_FUNC__ );
...
unsigned long
    LoggingServicePrivate::periodicalCheck ( ) const
{
    LOG4CXX_TRACE ( log4cxx::Logger::getRootLogger ( ), __LOG4CXX_FUNC__ );
...
void
    LoggingServicePrivate::periodicalCheck ( unsigned long delay )
{
    LOG4CXX_TRACE ( log4cxx::Logger::getRootLogger ( ), __LOG4CXX_FUNC__ );
...
void
    LoggingServicePrivate::loadConfig ( const std::string & configFilename )
{
    if ( log4cxx::LogManager::getLoggerRepository ( )->isConfigured ( ) )
    {
...
void
    LoggingServicePrivate::loadConfigAndWatch ( const std::string & configFilename )
{
    if ( log4cxx::LogManager::getLoggerRepository ( )->isConfigured ( ) )
    {
        if ( ! configFilename.empty ( ) )
...
void
    LoggingServicePrivate::loggerNames ( std::vector< std::string > & names )
{
    LOG4CXX_TRACE ( log4cxx::Logger::getRootLogger ( ), __LOG4CXX_FUNC__ );
...
bool
    LoggingServicePrivate::checkLogManagerStatus ( )
{

...
class ColorStdOuputLogMsg : public log4cxx::helpers::DateLayout
{
    ...
    public:
        ...
        virtual ~Term ( );
        FILE *
            getStandardStream ( const std::ostream & stream )
        {
         ...
         */
        bool
            isAttyTerminal ( const std::ostream & stream )
        {
        ...
        void
            winChangeAttributes ( std::ostream & stream, int foreground, int background = -1 )
        {
...
public:
    ...
    void
        setColor ( bool value );
    void
        setPrintLocation ( bool value );
    virtual void
        format ( log4cxx::LogString & output, log4cxx::spi::LoggingEventPtr const & event,
                 log4cxx::helpers::Pool & pool ) const;
    virtual void
        setOption ( const log4cxx::LogString & option, const log4cxx::LogString & value );
    ...
    std::ostream &
        onGrey ( std::ostream & stream );
    std::ostream &
        onRed ( std::ostream & stream );
    std::ostream &
        onGreen ( std::ostream & stream );
    std::ostream &
        onYellow ( std::ostream & stream );
    std::ostream &
        onBlue ( std::ostream & stream );
    std::ostream &
        onMagenta ( std::ostream & stream );
    std::ostream &
        onCyan ( std::ostream & stream );
    std::ostream &
        onWhite ( std::ostream & stream );
